...
export const Notification = {
  danger:
    "bg-red-300 opacity-90 border-red-500 hover:bg-red-400 hover:border-red-400",
  warning:
    "bg-yellow-400 opacity-90 border-yellow-500 hover:bg-yellow-400 hover:border-yellow-400",
  success:
    "bg-green-300 opacity-90 border-green-500 hover:bg-green-400 hover:border-green-400",
  default: "bg-transparent border-gray-400 text-black",
};
